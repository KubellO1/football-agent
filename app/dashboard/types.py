...
class DecisionStep:
    """决策流程中的单个步骤。"""
    step_name: str = ""           # "数据采集" / "模型计算" / "期望收益 EV" / "凯利仓位" / "风险评估" / "最终决策"
...
class DailyRiskProfile:
    ...
    kelly_breakdown: list = field(default_factory=list)  # [(match_market, kelly_pct), ...]


@dataclass
class BestOpportunity:
    """今日最佳机会 — 按市场类别展示最佳单笔推荐。"""
    category: str = ""             # "今日最佳投注" / "今日最佳大小球" / "今日最佳亚盘" / "今日最佳双方进球" / "今日最佳比分" / "今日最佳进球球员"
    match_label: str = ""
    market: str = ""
